...
public class RealStationService implements StationService {
    ...
    public Optional<SensorDataDTO> read() {
        ...
        try {
            ...
            humidity = (double) Math.round(humidity * 100) / 100;
            pressure = (double) Math.round(pressure * 100) / 100;
            temperature = (double) Math.round(temperature * 100) / 100;

            SensorDataDTO sensorDataDTO = new SensorDataDTO(humidity, pressure, temperature);
            return Optional.of(sensorDataDTO);

        } catch (Exception e) {
            System.out.println("Nie smiga");
        }
